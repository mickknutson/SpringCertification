...
public class BeforeAdvice {
	...
	//@Before("execution(* com.baselogic.tutorials.dao.*.*(..))")
	 ...
	 * @throws Throwable
	 */
	@Before("placeDelayedOrderService() && args(order,..)")
	public void beforeDelayedOrderDao(Order order) throws Throwable {
		logger.info(">>> ------------------------------------");
		logger.info(">>> ------------------------------------");
		logger.info(">>> ------------------------------------");
		logger.info(">>> ----- beforeOrderDao...>>> {}", order);
		...
		throw new Exception("beforeDelayedOrderDao");

		//order.adviceGiven.add("beforeDelayedOrderDao advice");
	}

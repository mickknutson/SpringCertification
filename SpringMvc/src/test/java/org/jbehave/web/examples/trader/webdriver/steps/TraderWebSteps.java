...
public class TraderWebSteps {
	...
	public void whenUserOpensCustomerFormPage() {
		pages.customerFormPage().open();
	}

	@Then("CustomerForm page is shown")
	public void customerFormPageIsShown() {
		pages.customerFormPage().pageIsShown();
	}

	@Then("page load is successful within timeout of $timeoutInSecs secs")
	public void pageLoadIsSuccessful(int timeoutInSecs) {
		pages.customerFormPage().runIsSuccessful(timeoutInSecs);
	}
